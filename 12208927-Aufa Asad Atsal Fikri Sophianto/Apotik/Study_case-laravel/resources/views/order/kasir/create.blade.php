...
@section('content')
    <div class="container mt-3">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                {{--nama dibuat array karena nantinya data obat (medicines) akan berbentuk array/data
...
@push ('script')
    <script>
        ...
        $("#add-select").on('click', function() {
            ...
            // append : tambahkan element html dibagian sblm penutup teg penutup terkait 
            //(sblm penutup taq yg id nya wrap-medicines)
            $("#wrap-medicines").append(el);
            // increments variable no agar yg muncul di option selalu bertambah 1 sesuai jumlah selectnya
                no++;
        });
    </script>
@endpush