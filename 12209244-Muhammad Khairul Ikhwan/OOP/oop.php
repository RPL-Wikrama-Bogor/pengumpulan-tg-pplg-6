    ...
    <div class="container">
        ...
        class FuelPurchaseForm
        {
            ...
            private function handleFormSubmission()
            {
                ...
                $this->showForm = false;
                $this->renderResult($jumlahLiter, $tipeBahanBakar, $totalHarga, $ppnAmount);
            }
            ...
            private function renderResult($jumlahLiter, $tipeBahanBakar, $totalHarga, $ppnAmount)
            {
                ?>
