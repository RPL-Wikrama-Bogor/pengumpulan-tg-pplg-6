              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                  ...
                  <?php if(Auth::check()): ?>
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" aria-current="page" href="<?php echo e(route('order.data')); ?>">Pembelian</a>
                        </li>
                        <li>
                          <a class="nav-link active" aria-current="page" href="<?php echo e(route('akun.index')); ?>">Kelola Akun</a>
                        </li>
...
</html><?php /**PATH C:\xampp\htdocs\apotek-app\resources\views/layouts/template.blade.php ENDPATH**/ ?>