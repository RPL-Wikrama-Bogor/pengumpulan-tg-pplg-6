...
<body>
    ...
    <form method="post" action="">
        <table>
            <tr>
            <td><label for="vip">Jumlah Tiket VIP Terjual</label></td>
            <td><input type="number" id="vip" name="vip" min="0"><br><br></td>
            </tr>
            <tr>
            <td><label for="executive">Jumlah Tiket Eksekutif Terjual</label></td>
            <td><input type="number" id="executive" name="executive" min="0"><br><br></td>
            </tr>
            <tr>
            <td><label for="economy">Jumlah Tiket Ekonomi Terjual</label></td>
            <td><input type="number" id="economy" name="economy" min="0"><br><br></td>
            </tr>
            <tr>
    ...
    if(isset($_POST['submit'])) {
        ...
        echo "Kelas VIP: $keuntunganVIP<br>";
        echo "Kelas Eksekutif: $keuntunganEksekutif<br>";
        echo "Kelas Ekonomi: $keuntunganEkonomi<br><br>";
