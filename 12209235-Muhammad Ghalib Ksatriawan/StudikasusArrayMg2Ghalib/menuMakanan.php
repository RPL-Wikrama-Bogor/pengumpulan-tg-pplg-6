...
<div class="container">
    <div class="border">
        <div class="m"> <h1>Menu Pecel Lele Pak Agus</h1></br> 
...
<div class="out">
    <?php if ($pesanMakanan !== "" || $pesanMinuman !== "") : ?>
        ...
        <?php endif; ?>
        <p>Total Pesanan Anda Setelalah Diskon: Rp <?php echo number_format($totalPesanan, 0, ',', '.'); ?></p>
        
        <?php
        // Tambahkan output total diskon dan jumlah item yang dibeli di sini
        $jumlahItemDibeli = $jumlahMakanan + $jumlahMinuman;
        $diskonText = ($jumlahItemDibeli > 5) ? "Diskon 10%: Rp " . number_format($diskon, 0, ',', '.') : "Tidak ada diskon";
        ?>
        
        <p><?php echo $diskonText; ?></p>
        <p>Jumlah Item yang Dibeli: <?php echo $jumlahItemDibeli; ?></p>
    <?php endif; ?>
</div>
