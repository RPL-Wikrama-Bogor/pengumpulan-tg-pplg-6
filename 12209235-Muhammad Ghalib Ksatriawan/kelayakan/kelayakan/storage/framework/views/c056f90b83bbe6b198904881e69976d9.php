                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="userPages" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('guru.index')); ?>" class="sidebar-link mx-4"><i
                                        class="ri-table-fill"></i> Data Guru</a>
                            </li>
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('user.index')); ?>" class="sidebar-link mx-4"><i
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="suratPages" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                            <li class="sidebar-item">
                                <a href="<?php echo e(route('lettertype.index')); ?>" class="sidebar-link mx-4"><i class="ri-table-fill"></i> Data
                                    Klasifikasi Surat</a>
                            </li>
                            <li class="sidebar-item">
...
<?php /**PATH C:\xampp\htdocs\kelayakan\resources\views/layouts/template.blade.php ENDPATH**/ ?>