...
<body>
    ...
    <div id="receipt">
        ...
        <div id="mid">
            <div class="info">
                <p>
                    Alamat : Jl. Raya Siliwangi, Benda, Kec. Cicurug, Kab. Sukabumi <br>
                    Email : inireyhann03@gmail.com <br>
                    Phone : 12209113 <br>
                </p>
            </div>
        </div>
        <div id="bot">
            ...
            <div id="legalcopy">
                <p class="legal"><strong>Terima Kasih Atas Pembelian Anda!</strong>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Explicabo, officiis non nostrum tempore fugiat laboriosam.</p>
            </div>
        </div>
    </div>
</body>
