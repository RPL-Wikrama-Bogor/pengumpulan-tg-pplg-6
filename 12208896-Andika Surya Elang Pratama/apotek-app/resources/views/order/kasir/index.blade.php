...
@section('content')
    <div class="container mt-3">
        <form class="d-flex" style="width: 350px; display:flex; margin-bottom:-35px;" method="GET" >
            <input name="mencari" class="form-control me-2" type="text" placeholder="Search" aria-label="Search">
            ...
            <tbody>
                ...
                @foreach ($orders as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('kasir.order.download', $item['id']) }}" class="btn btn-primary">download Struk</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
