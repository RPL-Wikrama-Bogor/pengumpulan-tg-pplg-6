                    ...
                    <table>
                        <tr>
                            <td>
                                <ol>
                                    <b>Makanan</b>
                                    <li>Menu : Nasi Cumi Hitam Pak Kris <br> Harga : 65000 </li>
                                    <li>Menu : Mie Apa <br> Harga : 50000 </li>
                                    <li>Menu : Bakso Bulat <br> Harga : 35000 </li>
                                </ol>
                                <ol>
                                    <b>Minuman</b>
                                    <li>Menu : Es Zeus <br> Harga : 20000 </li>
                                    <li>Menu : Teh Geledek <br> Harga : 30000 </li>
                                </ol>
                            </td>
                        </tr>
                    </table>
...
foreach ($listmenu as $key => $menu) {
    if ($menu['Kategori'] === 'Makanan') {
                                              ...
                                              echo  "<option value='" . $key . "'>" . $menu['Nama'] . "</option>";
