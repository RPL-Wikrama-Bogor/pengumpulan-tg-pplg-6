    ...
    <?php
        if(isset($_POST['submit'])){
            ...
            if ($bilangan_pertama > $bilangan_kedua && $bilangan_pertama > $bilangan_ketiga){
                ...
                echo "Bilangan Pertama dan Bilangan Kedua adalah yang terbesar: " . $bilangan_pertama;
            }
            else if ($bilangan_pertama == $bilangan_ketiga){
                echo "Bilangan Pertama dan Bilangan Ketiga adalah yang terbesar: " . $bilangan_pertama;
            }
            else if ($bilangan_kedua == $bilangan_ketiga){
                echo "Bilangan kedua dan Bilangan Ketiga adalah yang terbesar: " . $bilangan_kedua;
            }
            else {
                echo "Sama Besar";
            }
