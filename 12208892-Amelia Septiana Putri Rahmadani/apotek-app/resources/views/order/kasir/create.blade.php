            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    ...
                    <select name="medicines[]" id="medicines" class="form-select">
                        <option selected hidden disabled>Pesenan 1</option>
...
//append:tambahkan elemenr html dibagikan sebelum penutup tag penutup terkait (sebelum penutup tag yang idnya wrap-medicines)
                $("#wrap-medicines").append(el);
                //increments variable no agar angka yang munculdi option selalubertambah 1 sesuai jumlah selectnya
                no++
        });
    </script>
@endpush