...
Route::middleware(['IsLogin', 'IsAdmin'])->group(function(){
    ...
    Route::prefix('/medicine')->name('medicine.')->group(function() {
        Route::get('/create', [MedicineController::class, 'create'])->name('create'); //get = mengambil data
        Route::post('/store', [MedicineController::class, 'store'])->name('store'); // menyimpan atau mengirim data
        Route::get('/', [MedicineController::class, 'index'])->name('home'); // mengambil data
        Route::get('/{id}', [MedicineController::class, 'edit'])->name('edit');
        Route::patch('/{id}', [MedicineController::class, 'update'])->name('update'); //update data
    ...
    Route::prefix('/order')->name('order.')->group(function(){
        ...
        Route::get('/ecport-excel', [OrderController::class, 'exportExcel'])->name('export-excel');
    });         
});
