...
if (isset($_POST['submit'])) {
    ...
    if ($jml_makanan >= 5) {
        $diskon_makanan = 0.1; // Diskon 10%
    } elseif ($jml_makanan >= 3) {
        $diskon_makanan = 0.05; // Diskon 5%
    } else {
        $diskon_makanan = 0; // Tidak ada diskon
    }

    if ($jml_makanan >= 5) {
        $diskon_minuman = 0.1; // Diskon 10%
    } elseif ($jml_minuman >= 3) {
        $diskon_minuman = 0.05; // Diskon 5%
    } else {
        $diskon_minuman = 0; // Tidak ada diskon
    }
