...
asort($nilai2);
echo "ketika diurutkan dari yang terkecil menjadi : <b>" . implode(", ", $nilai2) . "</b> <br />";
//asort untuk mengurutkan dari yang terkecil-terbesar
arsort($nilai2);
echo "ketika diurutkan dari yang terbesar menjadi : <b>" . implode(", ", $nilai2) . "</b> <br />";
//arsort untuk mengurutkan dari yang terbesar-terkecil
echo "Apabila dibulatkan, rata-rata dari semua nilai saya menjadi : <b>" . round(array_sum($nilai)/count($nilai)) . "</b> <br />";
