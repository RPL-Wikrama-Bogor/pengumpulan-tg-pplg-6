...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::D2lCLrQ3lCNNFWx6',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::EYvbMY0C4OtfzTmk',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      '/admin/order/download-excel' => 
      array (
        0 => 
        array (
          0 => 
          array (
            '_route' => 'admin.order.download-excel',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/medicine/(?|edit/([^/]++)(*:33)|update/([^/]++)(*:55)|delete/([^/]++)(*:77)|([^/]++)(*:92)|stock/update/([^/]++)(*:120))|/user/(?|edit/([^/]++)(*:151)|update/([^/]++)(*:174)|delete/([^/]++)(*:197))|/order/(?|struk/([^/]++)(*:230)|download\\-pdf/([^/]++)(*:260)))/?$}sDu',
    ),
    3 => 
    array (
      33 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\UserController@authLogin',
        'controller' => 'App\\Http\\Controllers\\UserController@authLogin',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\MedicineController@stockData',
        'controller' => 'App\\Http\\Controllers\\MedicineController@stockData',
        'as' => 'medicine.data.stock',
        'namespace' => NULL,
        'prefix' => '/medicine',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\OrderController@data',
        'controller' => 'App\\Http\\Controllers\\OrderController@data',
        'as' => 'admin.order.data',
        'namespace' => NULL,
        'prefix' => '/admin/order',
        'where' => 
    ...
    array (
      ...
      'uri' => 'admin/order/download-excel',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\OrderController@downloadExcel',
        'controller' => 'App\\Http\\Controllers\\OrderController@downloadExcel',
        'as' => 'admin.order.download-excel',
        'namespace' => NULL,
        'prefix' => '/admin/order',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\OrderController@cari',
        'controller' => 'App\\Http\\Controllers\\OrderController@cari',
        'as' => 'admin.order.cari',
        'namespace' => NULL,
        'prefix' => '/admin/order',
        'where' => 
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\OrderController@strukPembelian',
        'controller' => 'App\\Http\\Controllers\\OrderController@strukPembelian',
        'as' => 'order.struk',
        'namespace' => NULL,
        'prefix' => '/order',
        'where' => 
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\OrderController@downloadPDF',
        'controller' => 'App\\Http\\Controllers\\OrderController@downloadPDF',
        'as' => 'order.download-pdf',
        'namespace' => NULL,
        'prefix' => '/order',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'controller' => 'App\\Http\\Controllers\\OrderController@search',
        'as' => 'order.search',
        'namespace' => NULL,
        'prefix' => '/order',
        'where' => 
