        ...
        <tbody>
            ...
            @foreach ($medicines as $medicine)
                <tr>
                    ...
                    <td>{{ $medicine['name'] }}</td>
                    <td
                        style="{{ $medicine['stock'] <= 3 ? 'background: red; color: white' : 'background: none; color: black' }} ">
                        {{ $medicine['stock'] }}</td>
                    <td class="d-flex justify-content-center">
                        <div onclick="edit({{ $medicine['id'] }})" class="btn btn-primary me-3" style="cursor: pointer">Tambah
                            Stock</div>
                    </td>
                </tr>
            @endforeach
