<style>
    ...
    <style>
        ...
        .navbar {
            background-color: #003049; /* Warna biru tua */
        }
        ...
        .sb-sidenav-menu .nav-link:hover {
            color: #ffbf00 !important; /* Warna kuning tua saat hover */
        }

        .sb-sidenav-menu .sb-sidenav-collapse-arrow {
            color: #fff; /* Warna putih */
        }

        .sb-sidenav-menu .sb-sidenav-collapse-arrow:hover {
            color: #ffbf00; /* Warna kuning tua saat hover */
        }
    </style>
</style>
<div class="container">
