                ...
                <form action="{{ route('kasir.order.index') }}" class="w-100 d-flex align-items-center" method="get">
                    ...
                    <div class="col-4">
                        <div class="d-flex">
                            ...
                            <a href="{{ route('kasir.order.clear') }}" class="btn btn-secondary m-1"
                                id="clear_data">Clear</a>
                        </div>
                    </div>
            ...
            <tbody>
                ...
                @foreach ($orders as $order)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('kasir.order.download', $order['id']) }}" class="btn btn-secondary">Download
                                Struk</a>
                        </td>
                    </tr>
                @endforeach
